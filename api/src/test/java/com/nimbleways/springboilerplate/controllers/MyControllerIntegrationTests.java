...
public class MyControllerIntegrationTests {
        ...
        private static List<Product> createProducts() {
                ...
                products.add(new Product(null, 15, 30, ProductTypeEnum.NORMAL, "USB Cable", null, null, null));
                products.add(new Product(null, 10, 0, ProductTypeEnum.NORMAL, "USB Dongle", null, null, null));
                products.add(new Product(null, 15, 30, ProductTypeEnum.EXPIRABLE, "Butter", LocalDate.now().plusDays(26), null,
                                null));
                products.add(new Product(null, 90, 6, ProductTypeEnum.EXPIRABLE, "Milk", LocalDate.now().minusDays(2), null, null));
                products.add(new Product(null, 15, 30, ProductTypeEnum.SEASONAL, "Watermelon", null, LocalDate.now().minusDays(2),
                                LocalDate.now().plusDays(58)));
                products.add(new Product(null, 15, 30, ProductTypeEnum.SEASONAL, "Grapes", null, LocalDate.now().plusDays(180),
